    ...
    return (
        <div className="w-screen flex flex-row items-center justify-center absolute bottom-[100px] mx-auto md:bottom-[10px]">
            <span className="py-2 text-[12px] text-white-200 ">
                Powered with 💖 by <CustomLink target="_blank" href="https://github.com/inestmimi4/MyPortfolio" className="text-green-200 underline hover:text-green-200">Ines_Tmimi</CustomLink>
            </span>
        </div>
    )
}